...
<template>
  <div class="grid w-full max-w-[260px] gap-2 rounded-[18px] border border-[#d9dce5] bg-white px-3 py-2 max-[900px]:min-w-0">
    ...
    <div
      class="relative h-[18px] before:absolute before:left-0 before:top-1/2 before:h-1 before:w-full before:-translate-y-1/2 before:rounded-full before:bg-[linear-gradient(to_right,#e5e7eb_0%,#e5e7eb_var(--range-start),#2945ff_var(--range-start),#2945ff_var(--range-end),#e5e7eb_var(--range-end),#e5e7eb_100%)] [&_input]:pointer-events-none [&_input]:absolute [&_input]:left-0 [&_input]:top-0 [&_input]:m-0 [&_input]:h-[18px] [&_input]:w-full [&_input]:appearance-none [&_input]:bg-transparent [&_input::-moz-range-thumb]:pointer-events-auto [&_input::-moz-range-thumb]:h-[18px] [&_input::-moz-range-thumb]:w-[18px] [&_input::-moz-range-thumb]:rounded-full [&_input::-moz-range-thumb]:border-0 [&_input::-moz-range-thumb]:bg-[#2945ff] [&_input::-moz-range-track]:h-1 [&_input::-moz-range-track]:bg-transparent [&_input::-webkit-slider-runnable-track]:h-1 [&_input::-webkit-slider-runnable-track]:bg-transparent [&_input::-webkit-slider-thumb]:pointer-events-auto [&_input::-webkit-slider-thumb]:relative [&_input::-webkit-slider-thumb]:z-10 [&_input::-webkit-slider-thumb]:mt-[-7px] [&_input::-webkit-slider-thumb]:h-[18px] [&_input::-webkit-slider-thumb]:w-[18px] [&_input::-webkit-slider-thumb]:appearance-none [&_input::-webkit-slider-thumb]:rounded-full [&_input::-webkit-slider-thumb]:bg-[#2945ff]"
      :style="rangeStyle"
    >
      <input
        :min="min"
